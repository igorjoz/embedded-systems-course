...
def update_reading():
    ...
    reading_text.value = "Pressure = " + str(data[0]) + "\nTemperature = " + str(data[1])
...
app = App(width=500, height=300, bg="white")
drawing = Drawing(app, width = 400, height=200)
reading_text = Text(app, size=30, font="Helvetica")
reading_text.repeat(500, update_reading)
 
id_rec = drawing.rectangle(10, 10, 300, 100, color="pink")
drawing.text(10, 10, "Put the mouse here", color="white", font="Helvetica", size=None, max_width=None)
drawing.when_mouse_enters = do_this
drawing.when_mouse_leaves = do_that
 
#id_rec2 = drawing.rectangle(10, 10, 300, 100, color="yellow")
